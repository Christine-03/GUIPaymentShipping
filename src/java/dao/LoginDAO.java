...
public class LoginDAO {
    ...
    public boolean loginUser(Login login, HttpServletRequest request) {
        ...
        try {
            ...
            String sql = "SELECT * FROM APP.\"USER\" WHERE NBUSER.\"email\" = ? AND NBUSER.\"password\" = ?";
    ...
    public boolean isEmailRegistered(String email) {
        ...
        try {
            ...
            String sql = "SELECT * FROM NBUSER.\"USER\" WHERE NBUSER.\"email\" = ?";
            PreparedStatement pst = con.prepareStatement(sql);
    ...
    try {
        ...
        String sql = "SELECT * FROM NBUSER.\"USER\" WHERE NBUSER.\"email\" = ? AND NBUSER.\"password\" = ?";
        PreparedStatement pst = con.prepareStatement(sql);
        pst.setString(1, login.getEmail());
        pst.setString(2, login.getPassword());
    ...
    public boolean registerUser(User user) {
        ...
        try {
            ...
            String sql = "INSERT INTO NBUSER.\"USER\" (\"name\", \"username\", \"birth\", \"email\", \"mobileNo\", \"password\", \"role\") VALUES (?, ?, ?, ?, ?, ?, ?)";
            PreparedStatement pst = con.prepareStatement(sql);
